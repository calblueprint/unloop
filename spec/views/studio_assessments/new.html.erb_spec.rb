...
RSpec.describe "studio_assessments/new", type: :view do
  before(:each) do
    assign(:studio_assessment, StudioAssessment.new(
      :name => "MyString",
      :participant_id => "",
      :bigpicture_score => 1,
  ...
  it "renders new studio_assessment form" do
    render

    assert_select "form[action=?][method=?]", studio_assessments_path, "post" do
